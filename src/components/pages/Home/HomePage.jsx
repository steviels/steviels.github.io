...
export default function HomePage () {
    return (
        <div id = "hero-page" className = "grid grid-cols-1 grid-rows-[90vh_.65fr_.65fr] md:grid-cols-2 md:grid-rows-[95vh_1fr] gap-x-4 min-h-screen h-full w-full text-white bg-[#09131c]">
